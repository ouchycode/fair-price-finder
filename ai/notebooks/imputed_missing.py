...
DATA_CLEAN_DIR = Path(__file__).resolve().parents[2] / "data" / "raw" / "data" / "cleaned"
INPUT_PATH = DATA_CLEAN_DIR / "merged_raw.csv"
OUTPUT_PATH = DATA_CLEAN_DIR / "merged_raw_imputed.csv"
